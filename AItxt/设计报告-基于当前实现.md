...
- `backend/mocks/data/mock-funds-db.json`：资金账户、余额、密码、资金流水
- `backend/mocks/data/mock-securities-db.json`：证券持仓、证券流水
- `backend/mocks/data/mock-exchange-db.json`：委托与成交
- `backend/mocks/data/mock-market-db.json`：行情快照
...
2. 运行 `start-gateway.cmd` 启动网关与 mock 服务
